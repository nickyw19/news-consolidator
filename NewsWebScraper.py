...
class NewsWebScraper():
    ...
    # Make a HTTP Get request to the News Source's website and extract data using BeautifulSoup
    def get_html(self, news_source, url, num):
        try:
            ...
            print(f"An error occurred during data extraction and filtering: {e}")
            return None
